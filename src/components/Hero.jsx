...
import Team from "../assets/ACM/Team.jpg";
            ...
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490] ">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <ul className="hidden absolute -left-[7.5rem] bottom-[1.5rem] px-1 py-1 bg-n-9/40 backdrop-blur border border-n-1/10 rounded-2xl xl:flex">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <Notification
                    className="hidden absolute -right-[7.5rem] bottom-[5rem] w-[18rem] xl:flex"
                    title="Recently Visit"
                  />
                </ScrollParallax>
              </div>
            </div>
